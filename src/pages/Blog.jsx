  ...
  const defaultPosts = [
    {
      ...
      text: "Working on AI-based systems like phishing detection has taught me how impactful technology can be when applied to cybersecurity. Combining deep learning with real-world problems is my favorite way to innovate.",
    },
    {
      id: 2,
